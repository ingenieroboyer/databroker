...
personal.rename(columns={'direccion':'address','telefono1':'phone1',
                 ...
                 inplace=True)
nombres = pd.DataFrame(personal.nombre.str.split(' ',1,expand=False).tolist(),columns = ['nombrecito1','nombrecito2'])
personal['firstname1']=nombres['nombrecito1']
personal['firstname2']=nombres['nombrecito2']
...
nombres = pd.DataFrame(fijo_cdf.firstname1.str.split(' ',1,expand=False).tolist(),columns = ['nombrecito1','nombrecito2'])
fijo_cdf['firstname1']=nombres['nombrecito1']
fijo_cdf['firstname2']=nombres['nombrecito2']
fijo_cdf = fijo_cdf.dropna(axis=0, subset=['sex']) ## puede cambiar este criterio
# Cambiar valor de sexo por str
fijo_cdf.loc[fijo_cdf.sex==0.0,['sex']]='m'
fijo_cdf.loc[fijo_cdf.sex==1.0,['sex']]='f'
...
nombres = pd.DataFrame(personal.import pandas as pd
from pymongo import MongoClient
client = MongoClient()
db = client.erme
...
nombre.str.split(' ',1,expand=False).tolist(),columns = ['nombrecito1','nombrecito2'])
personal['firstname1']=nombres['import pandas as pd
from pymongo import MongoClient
client = MongoClient()
db = client.erme
